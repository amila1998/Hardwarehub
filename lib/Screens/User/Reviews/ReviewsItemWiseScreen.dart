...
class ReviewsItemWiseScreen extends StatelessWidget {
  ...
  const ReviewsItemWiseScreen({required this.item, Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final reviewProvider = Provider.of<ReviewProvider>(context);
    final user = FirebaseAuth.instance.currentUser;
    reviewProvider.loadReviewsForItem(item.id);
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                ' $reviewCount Reviews on this Item ',
                style: TextStyle(
                  fontSize: 20.0,
